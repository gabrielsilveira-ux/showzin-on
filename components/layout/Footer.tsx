...
export default function Footer() {
  return (
    <footer style={{ background: '#0f0f14', color: 'rgba(255,255,255,0.65)' }} className="pt-12 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-10">
          <div className="col-span-2 md:col-span-1">
            <p style={{ fontFamily: "'Space Grotesk',sans-serif", fontWeight: 700, fontSize: '1.3rem', color: '#fff', letterSpacing: '-0.02em' }}>
